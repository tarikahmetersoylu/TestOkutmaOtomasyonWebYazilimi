        ...
        <div id="Icerik">
            ...
            <div class="form-group" id="testOkutma">
                ...
                <div class="custom-file  sel1">
                    ...
                    <button onclick="ogrenciTabloDoldur()" data-target="#ogrenciCevapDuzenleModal" data-toggle="modal" type="submit" class="btn btn-primary" style="width: 20%; margin-bottom: 30px padding-bottom:50px;">Düzenle</button>
                </div>
                <br> <br>
                ...
                <div class="custom-file sel1">
                    ...
                    <form action="ogrenciCevaplarTablosu.html" method="POST">
                        <button onclick="cevapAnahtariTabloDoldur()" data-target="#cevapAnahtariDuzenleModal" data-toggle="modal" type="button" class="btn btn-primary" style="width: 20%;">Düzenle</button>
                    </form>
                </div>
